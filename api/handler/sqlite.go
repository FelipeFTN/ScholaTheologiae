...
// SQLiteHandler is a struct that holds the database connection
...
// NewSQLite creates a new SQLiteHandler
func NewSQLite(dbConnections map[string]string) (*SQLiteHandler, error) {
